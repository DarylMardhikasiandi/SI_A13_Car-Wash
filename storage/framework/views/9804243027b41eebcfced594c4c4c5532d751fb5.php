...
<div class="container mt-5">
    ...
    <div class="d-flex">
      <a type="button" class="btn btn-danger" href="/" role="button" style="margin-top: 2rem; font-weight: bold; text-align:center; width:500px;">Kembali</a>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\King-Wash\King-Wash\resources\views/user/history.blade.php ENDPATH**/ ?>