...
<div class="container mt-5" style="background-color: white; width: 80rem; height: 28rem; border-radius: 1rem;">
    ...
    <?php echo csrf_field(); ?>
        <div class="col-6">
            ...
            <input type="text" class="form-control" id="inputAddress" placeholder="Username" name="nama">
          </div>
        <div class="col-md-6">
          ...
          <div class="col-6">
            ...
            <input type="text" class="form-control" id="inputAddress2" placeholder="0812xxxxxxxx" name="notelp">
          </div>
        <div class="col-md-6">
            <label for="inputAddress" class="form-label">Tanggal Booking</label>
            <input type="date" class="form-control" id="inputAddress" placeholder="dd/xx/yyyy" name="tanggal">
        </div>
        <div class="col-6">
          <label for="inputAddress" class="form-label">Merk</label>
          <input type="text" class="form-control" id="inputAddress" placeholder="Toyota Avanza" name="merk">
        </div>
        <div class="col-6">
          <label for="inputAddress2" class="form-label">Plat Nomor</label>
          <input type="text" class="form-control" id="inputAddress2" placeholder="L 1234 XY" name="plat">
        </div>
        <div class="col-12">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\applications\King-Wash\resources\views/user/booking.blade.php ENDPATH**/ ?>