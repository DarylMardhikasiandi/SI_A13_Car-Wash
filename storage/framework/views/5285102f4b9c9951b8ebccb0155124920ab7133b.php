...
<div class="container mt-5" style="background-color: white; width: 80rem; height: 28rem; border-radius: 1rem;">
    ...
    <?php echo method_field('PATCH'); ?>
        <div class="col-6">
            ...
            <input type="text" value="" class="form-control" id="inputAddress" placeholder="Username" name="nama" required>
          </div>
        <div class="col-md-6">
          <label for="category" class="form-label ms-auto">Layanan</label>
          <select class="form-select" value="" aria-label="Default select example" name="layanan" required>
          ...
          <div class="col-6">
            ...
            <input type="text" value="" class="form-control" id="inputAddress2" placeholder="0812xxxxxxxx" name="notelp" required>
          </div>
        <div class="col-md-6">
            <label for="inputAddress" class="form-label">Tanggal Booking</label>
            <input type="date" value="" class="form-control" id="inputAddress" placeholder="dd/xx/yyyy" name="tanggal" required>
        </div>
        <div class="col-6">
          <label for="inputAddress" class="form-label">Merk</label>
          <input type="text" value="" class="form-control" id="inputAddress" placeholder="Toyota Avanza" name="merk" required>
        </div>
        <div class="col-6">
          <label for="inputAddress2" class="form-label">Plat Nomor</label>
          <input type="text" value="" class="form-control" id="inputAddress2" placeholder="L 1234 XY" name="plat" required>
        </div>
        <div class="col-12">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\King-Wash\King-Wash\resources\views/user/edit.blade.php ENDPATH**/ ?>